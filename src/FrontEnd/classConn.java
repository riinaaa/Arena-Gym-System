 ...
 * @author RinaA
 */
public class classConn extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/FrontEnd/IMG/classCon.jpg"))); // NOI18N
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(classConn.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
